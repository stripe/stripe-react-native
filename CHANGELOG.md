...
- Fixed Android crash `IllegalStateException: Cannot locate windowRecomposer` in EmbeddedPaymentElement when React Native measures the view before it's attached to a window.
