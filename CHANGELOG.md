...
* [Fixed] Calling `confirmPayment` without `params` no longer crashes in debug iOS builds when the payment method is already attached server-side. ([#2331](https://github.com/stripe/stripe-react-native/issues/2331))
