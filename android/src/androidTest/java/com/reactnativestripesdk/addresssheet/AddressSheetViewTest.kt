...
class AddressSheetViewTest {
  ...
  fun buildAddressDetails_Default() {
    val addressDetails = AddressSheetView.buildAddressDetails(bundleOf())
  ...
  fun buildAddress_Default() {
    val address = AddressSheetView.buildAddress(bundleOf())
  ...
  fun buildAdditionalFieldsConfiguration_Custom() {
    ...
    Assert.assertEquals(received.checkboxLabel, label)
  }
