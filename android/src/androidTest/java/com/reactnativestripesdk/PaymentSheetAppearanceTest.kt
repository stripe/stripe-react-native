...
class PaymentSheetAppearanceTest {
  ...
  fun testFullEmbeddedAppearance_FlatWithRadio() {
    ...
    val flatRadioColorsBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FlatWithRadio.Colors.Builder()
    ...
    val flatRadioBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FlatWithRadio.Builder()
  ...
  fun testFullEmbeddedAppearance_FlatWithCheckmark() {
    ...
    val flatCheckmarkColorsBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FlatWithCheckmark.Colors.Builder()
    flatCheckmarkColorsBuilder.separatorColor(testColor)
    flatCheckmarkColorsBuilder.checkmarkColor(testColor)

    val flatCheckmarkBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FlatWithCheckmark.Builder()
  ...
  fun testFullEmbeddedAppearance_FlatWithDisclosure() {
    ...
    val flatDisclosureColorsBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FlatWithDisclosure.Colors.Builder()
    flatDisclosureColorsBuilder.separatorColor(testColor)
    flatDisclosureColorsBuilder.disclosureColor(testColor)

    val flatDisclosureBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FlatWithDisclosure.Builder()
  ...
  fun testFullEmbeddedAppearance_FloatingButton() {
    ...
    val floatingButtonBuilder = PaymentSheet.Appearance.Embedded.RowStyle.FloatingButton.Builder()
