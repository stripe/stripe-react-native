  ...
  companion object {
    ...
    private fun mapFromAccountsList(accounts: FinancialConnectionsAccountList): ReadableArray {
      ...
      for (account in accounts.data) {
        ...
        map.putDouble("created", account.created * MILLIS_PER_SECOND.toDouble())
    ...
    private fun mapFromAccountBalance(balance: Balance?): WritableMap? {
      ...
      val map = Arguments.createMap()
      map.putDouble("asOf", balance.asOf * MILLIS_PER_SECOND.toDouble())
    ...
    private fun mapFromAccountBalanceRefresh(balanceRefresh: BalanceRefresh?): WritableMap? {
      ...
      map.putDouble(
        "lastAttemptedAt",
        balanceRefresh.lastAttemptedAt * MILLIS_PER_SECOND.toDouble(),
      )
      return map
    }
