...
> **Please note**: Expo is currently supported via [EAS Build](https://docs.expo.io/build/introduction/) and the bare workflow, but usage of this library in the Expo Go app is still in progress.
