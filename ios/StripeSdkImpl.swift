...
public class StripeSdkImpl: NSObject, UIAdaptivePresentationControllerDelegate {
    ...
    var clientSecretProviderProvideSetupIntentClientSecretCallback: ((String) -> Void)? = nil
    var clientSecretProviderProvidesCustomerSessionClientSecretCallback: ((CustomerSessionClientSecret) -> Void)? = nil
