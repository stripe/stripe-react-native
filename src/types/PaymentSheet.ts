...
export interface CurrencySelectorAppearance {
   ...
   *
   * @default iOS: UIColor.tertiarySystemFill
   * @default Android: Theme surface color
   */
   ...
   *
   * @default iOS: white (light) / tertiaryLabel (dark)
   * @default Android: Theme primary color
   */
   ...
   *
   * @default iOS: UIColor.separator
   * @default Android: Theme onSurface at 12% alpha
   */
   ...
   *
   * @default iOS: UIColor.label
   * @default Android: Theme onComponent color
   */
   ...
   *
   * @default iOS: UIColor.label
   * @default Android: Theme onPrimary color
   */
   ...
   *
   * @default iOS: UIColor.secondaryLabel
   * @default Android: Theme subtitle color
   */
   ...
   *
   * @default iOS: UIColor.systemRed
   * @default Android: Theme error color
   */
   ...
   * - `family`: font family name (PostScript name on iOS, resource name on Android)
   * - `scale`: multiplier applied to all font sizes (must be > 0)
   *
   * @default System font at platform-default scale
   */
