...
`useConfirmPayment` returns a promise will be resolved when the payment completes. It will be rejected with error object. Inspect `code` field to determine the cause.
